...
@WebServlet("/pagPrincipal")
public class pagPrincipal extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/p/pagPrincipal.jsp");
