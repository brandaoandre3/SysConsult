...
@WebServlet(name = "RelAtestado", description = "Relatório de Atestados", urlPatterns = { "/RelAtestado" })
public class RelAtestado extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Collection<Atestado> atestados = new AtestadoDAO().buscaPorSimilaridade(filtro);
		//Gravando dados em um objeto na memória
		req.setAttribute("atestados", atestados);
		//Reenviando pedidos para outra página ou servlet
		RequestDispatcher dispatcher = req.getRequestDispatcher("WEB-INF/r/relAtestado.jsp");
