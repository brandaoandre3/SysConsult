...
@WebServlet(name = "RelPaciente", description = "Relatório de Pacientes", urlPatterns = { "/RelPaciente" })
public class RelPaciente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Collection<Paciente> pacientes = new PacienteDAO().buscaPorSimilaridade(filtro);
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("WEB-INF/r/relPaciente.jsp");
