...
@WebServlet(name = "RelResultadoExame", description = "Relatório de Resultados de Exames", urlPatterns = { "/RelResultadoExame" })
public class RelResultadoExame extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public RelResultadoExame() {
        super();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Collection<ResultadoExame> resultadoExame = new ResultadoExameDAO().buscaPorSimilaridade(filtro);
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("WEB-INF/r/relResultadoExame.jsp");
