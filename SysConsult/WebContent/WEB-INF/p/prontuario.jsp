...
<html>
	...
	<div class="content-wrapper">
	    ...
	    <section class="content-header">
	    	<h1>
	        	Prontuário
	        	<small>Prontuário Médico</small>
	      	</h1>
	      	<ol class="breadcrumb">
	        	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
	        	<li class="active">Prontuário Médico</li>
	      	</ol>
		        ...
		        <div class="row">
	                <fieldset class="col-md-9">
	                    ...
	                    <div class="row form-group">                   
	                        ...
	                        <div class="col-md-1"> Prontuário</div>
	                        <div class="col-md-2">
                    ...
                    <fieldset class="col-md-9">
                    	<legend>Informações do Procedimentos</legend>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            <div class="col-md-2">Diagnósticos</div>
                            <div class="col-md-10 "><textarea class="form-control"></textarea></div>
                        </div>
                        <div class="row form-group">
                        ...
                        <div class="row form-group">
                            <div class="col-md-2">Informações</div>
                            <div class="col-md-10 "><textarea class="form-control"></textarea></div>
                        </div>
                        <div class="row form-group">
